...
const SEED_INCIDENTS: Incident[] = [
  {
    ...
    mttrTarget: '00:15:00',
    node: 'order-svc',
    rootCause: 'Attacker exploited container misconfiguration to gain CAP_SYS_ADMIN, '
    ...
    confidence: 94.2,
    autoAction: 'Container isolation applied. Network policy blocking lateral movement.',
    timeline: [
      { time: '14:32:01', event: 'CAP_SYS_ADMIN acquired via setcap on order-svc (eBPF detected)', icon: '🔴' },
      { time: '14:32:03', event: 'PostgreSQL OOM kill — rss exceeded 4GB limit',                    icon: '🔴' },
      { time: '14:32:05', event: 'GNN causal chain confirmed: 94.2% confidence attack classification', icon: '🧠' },
      { time: '14:32:08', event: 'Guardian RL proposed: isolate_container + block_ip',              icon: '🛡' },
      { time: '14:32:09', event: 'Ghost Preview simulated — risk 12/100, OPA PASS',                icon: '👻' },
      { time: '14:32:11', event: 'OPA policies validated (5/5 passed)',                             icon: '✅' },
      { time: '14:32:12', event: 'Container isolated. NetworkPolicy applied.',                      icon: '⚡' },
      { time: '14:32:25', event: 'TCP retransmit rate declining (187→34/s)',                        icon: '📉' },
    ],
  },
  {
    id: 'INC-2846',
    ...
    mttrTarget: '00:30:00',
    node: 'notify-svc',
    rootCause: 'Scheduler latency p99 spike to 142ms caused by CPU contention with order-svc '
      + 'OOM pressure on same physical node.',
    affected: ['notify-svc', 'kafka'],
    confidence: 87.1,
    autoAction: 'Scale-up triggered. Additional replica scheduled.',
    timeline: [
      { time: '14:18:44', event: 'sched_latency p99 exceeded 50ms threshold (eBPF)',       icon: '⚠️' },
      { time: '14:19:01', event: 'GNN root cause: CPU contention from order-svc node',      icon: '🧠' },
      { time: '14:19:15', event: 'Guardian proposed: scale_up_replicas notify-svc',         icon: '🛡' },
      { time: '14:19:20', event: 'Ghost Preview: risk 10/100, MTTR -30%',                  icon: '👻' },
      { time: '14:19:22', event: 'Scale-up approved + executing',                           icon: '⚡' },
    ],
  },
  {
    id: 'INC-2845',
    ...
    mttrTarget: '00:30:00',
    node: 'redis',
    rootCause: 'Memory pressure from order-svc query flood caused Redis maxmemory eviction storm.',
    affected: ['redis', 'order-svc'],
    confidence: 91.3,
    autoAction: 'Memory limit increased. Eviction policy tuned to allkeys-lru.',
    timeline: [
      { time: '13:55:12', event: 'Redis eviction rate > 10k/s detected',       icon: '⚠️' },
      { time: '13:55:30', event: 'GNN: query flood from order-svc identified',  icon: '🧠' },
      { time: '13:56:00', event: 'Memory limit +50% applied autonomously',      icon: '⚡' },
      { time: '14:03:32', event: 'Eviction rate normalised. Auto-resolved.',    icon: '✅' },
    ],
  },
  {
    id: 'INC-2844',
    ...
    timeline: [
      { time: '12:10:05', event: 'Error rate 8.4% (threshold 2%)',              icon: '⚠️' },
      { time: '12:10:20', event: 'GNN: upstream timeout from order-svc',        icon: '🧠' },
      { time: '12:12:00', event: 'Circuit breaker applied',                     icon: '⚡' },
      { time: '12:16:49', event: 'Error rate < 0.5%. Resolved.',                icon: '✅' },
    ],
  },
];
